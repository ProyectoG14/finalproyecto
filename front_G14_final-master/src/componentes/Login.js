...
const Login = () => {
  ...
  return (
   ...
   <center><h1 className="inline bg-gradient-to-r from-indigo-200 via-sky-600 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
      G14 Iniciar sesión Ecommerce 2
    </h1></center>
    <form 
      onSubmit={onSubmit}
    ...
    >
      <div className="my-5">
        <label className="uppercase text-sky-600 block text-lx font-bold">Email</label>
        <input 
        type="email"
        id="email"
        name="email"
...
<div className="my-5"></div>
        <label className="uppercase text-sky-600 block text-lx font-bold">Password</label>
        <input 
        type="password"
        id="password"
        name="password"
