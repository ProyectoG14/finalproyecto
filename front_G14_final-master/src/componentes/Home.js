...
const Home = () => {
  ...
  return (
   ...
   <h1 className="inline p-8 bg-gradient-to-r from-indigo-200 via-sky-700 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
      Proyecto G14 
    </h1>
    <Link
           className="block text-center my-5 bg-gradient-to-r from-indigo-200 via-sky-700 to-indigo-200 bg-clip-text font-display text-2xl tracking-tight text-transparent"
         to={"/login"}
         >
           Iniciar Sesión
         </Link>
   ...
   <div className="flex-1 bg-white">
      <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
        <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
          <h2 className="text-2xl font-bold tracking-tight text-sky-600">Shop by Category</h2>
          <a href="#" >
