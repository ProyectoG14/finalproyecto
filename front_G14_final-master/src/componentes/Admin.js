...
import ActualizarProducto from "./productos/ActualizarProductos";
...
<div className="md:flex md:min-h-screen">
  ...
  <main className="flex-1">
        <h1 className="inline bg-gradient-to-r from-blue-200 via-sky-600 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
          LISTA DE CATEGORIAS
